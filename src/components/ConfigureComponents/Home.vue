<template>
  <div>
    ...
    <b-form-select
      id="navbarVariant"
      v-model="config.app.navbarVariant"
    ...
    <label for="tagline" class="mt-2">Tagline</label>
    <b-form-input
      v-model="config.home.tagline"
      type="text"
      id="tagline"
    ...
    <label for="backgroundUrl" class="mt-2">Background URL</label>
    <b-form-input
      v-model="config.home.backgroundUrl"
      type="text"
      id="backgroundUrl"
